...
namespace PROJET_ASI.Data.Migrations
{
    ...
    [Migration("20240316135326_AjoutIDUtilisateurProprietaire")]
    partial class AjoutIDUtilisateurProprietaire
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PROJET_ASI.Models.Equipement", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PROJET_ASI.Models.Comporte", b =>
                {
                    b.HasOne("PROJET_ASI.Models.Equipement", "Equipement")
                        .WithMany("LesComporte")
            ...
            modelBuilder.Entity("PROJET_ASI.Models.Logement", b =>
                {
                    b.HasOne("PROJET_ASI.Models.Proprietaire", "Proprietaire")
                        .WithMany("LogementsAppartient")
            ...
            modelBuilder.Entity("PROJET_ASI.Models.Proprietaire", b =>
                {
                    b.Navigation("LogementsAppartient");
                });
